"""Four-step DBCache: one probe block, cached remaining-block residual.
...
class ResidualCache:
    ...
    def probe(self, before, after, step: int, valid_rows: int):
        ...
        eligible = (step >= self.options["warmup"] and step < 3 and
    ...
    def stats(self):
        return {"algorithm": "DBCache", "Fn": 1, "Bn": 0, **self.options,
